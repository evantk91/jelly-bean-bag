...
//We can put the logging in app.use(). The callback will be called before every route
//We can use the req.method property which will always equal to the verb of the HTTP request
app.use((req, res, next) => {
  console.log(`${req.method} Request Received`);
});

app.get('/beans/', (req, res, next) => {
  // we can remove the logging from each individual route
  // logRequest('GET'); 
