...
//we can refactor all the logic that checks the existence of a jelly bean
//this middleware will run for every request matching a specific path
app.use('/beans/:beanName', (req, res, next) => {
  ...
  //attach the correct bean to the request to be used in the next middleware
  req.bean = jellybeanBag[beanName];
  //we can also attach the bean name
...
app.get('/beans/:beanName', (req, res, next) => {
  ...
  // }
  // res.send(jellybeanBag[beanName]);
  res.send(req.bean); //replace with bean from request
  console.log('Response Sent');
});
