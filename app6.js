...
//app.use can take an array of paths
...
//we can add common functionality from put and post routes
//this functionality combines the HTTP request body into a single string
...
//refactor all post and put routes
