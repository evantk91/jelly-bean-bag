//incorporating morgan library

//we will replace the logging code with an open source libray for logging information about the HTTP request-response cycle
...
//remove all console.log calls, this is taken care of by the morgan library
